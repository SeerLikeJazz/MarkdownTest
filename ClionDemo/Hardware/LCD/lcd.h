...
#define	LCD_CS_SET    HAL_GPIO_WritePin(GPIOA, SPI1_CS_Pin, GPIO_PIN_SET)
#define	LCD_RS_SET    HAL_GPIO_WritePin(GPIOA, TFT_DC_Pin_Pin, GPIO_PIN_SET)
#define	LCD_RST_SET   HAL_GPIO_WritePin(GPIOA, TFT_RST_Pin_Pin, GPIO_PIN_SET)

#define	LCD_CS_CLR    HAL_GPIO_WritePin(GPIOA, SPI1_CS_Pin, GPIO_PIN_RESET)
#define	LCD_RS_CLR	  HAL_GPIO_WritePin(GPIOA, TFT_DC_Pin_Pin, GPIO_PIN_RESET)
#define	LCD_RST_CLR	  HAL_GPIO_WritePin(GPIOA, TFT_RST_Pin_Pin, GPIO_PIN_RESET)
